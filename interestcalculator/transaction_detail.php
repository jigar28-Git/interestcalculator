...
<title><?php echo $_SESSION['title']; ?> Transaction Details</title>
</head>
...
<body>
        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="mws-panel">
                        ...
                        <div class="mws-panel-body no-padding">
                            <form class="mws-form" action="" method="post" id="eventForm" onsubmit="return validate()">
                                        ...
                                        <label class="mws-form-label">Select Date</label>
                                            ...
                                            <div class="mws-form-cols">
                                                <div class="mws-form-col-2-8">
                                                    <input type="date" id ="date1" name="fromdate">
                                                </div>                                
                                                <div class="mws-form-col-0-8">
                                                    <label class="mws-form-label">-- TO --</label>
                                                </div>
                                                <div class="mws-form-col-2-8">
                                                    <input type="date" id ="date2" name="todate">
                                                </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="mws-button-row">
                                    <input type="submit" value="SHOW" name="filter" class="btn btn-danger">
                        ...
                        <table class="mws-table mws-datatable">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $q="SELECT * FROM `trans_details` AS T INNER JOIN customer_master AS C ON T.customer_id=C.customer_id ORDER BY trans_date";
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td><?php echo $row['customer_name']." - ".$row['city'];?></td>
                                    <td><?php echo $row['amount'];?></td>
                                    <td><?php echo $row['description'];?></td>
                                    <td>
                                        <span class="btn-group">
                                            <a href="add_transaction.php?id=<?php echo $row['customer_id'] ?>&mode=edit" class="btn btn-small"><i class="icon-pencil"></i></a>
                                            <a href="add_transaction.php?id=<?php echo $row['customer_id'] ?>&mode1=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-small"><i class="icon-trash"></i></a>
                                        </span>
                                    </td>
                                </tr>
                                <?php } }
                                ...
                                if($transtype == "all"){
                                    ...
                                    $q="SELECT * FROM `trans_details` AS T INNER JOIN customer_master AS C ON T.customer_id=C.customer_id WHERE T.customer_id IN ('$instructor') AND date(`trans_date`) BETWEEN '$date1' AND '$date2' AND trans_type IN ('$transtype')";
                                    //echo $q;
                                    $result=mysqli_query($con,$q);
    ...
    const lastDay = document.getElementById('date2');


    firstDay.value = new Date(now.getMonth(), 1, now.getFullYear());
    console.log(new Date(now.getMonth(), 1, now.getFullYear()));
                         
    lastDay.value = new Date(now.getMonth() + 1, 0, now.getFullYear());
    console.log(new Date(now.getMonth() + 1, 0, now.getFullYear())  );
